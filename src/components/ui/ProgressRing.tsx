/** Buca Yıldız — ProgressRing. Circular progress gauge. */
    ...
    <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
      <div style={{ position: "relative", width: size, height: size }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2 }}>
          <span style={{ fontFamily: "var(--font-stat)", fontWeight: 700, fontSize: size * 0.26, lineHeight: 1, color: "var(--text-strong)", fontVariantNumeric: "tabular-nums" }}>{display ?? `${Math.round(pct * 100)}%`}</span>
