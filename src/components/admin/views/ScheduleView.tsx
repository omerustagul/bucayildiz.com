...
export type SPitch = { id: string; name: string };
...
export function ScheduleView({ teams, athletes, pitches, trainings, fixtures, todayYmd }: {
  teams: STeam[]; athletes: SAthlete[]; pitches: SPitch[]; trainings: STraining[]; fixtures: SFixture[]; todayYmd: string;
}) {
  return (
    <>
      ...
      <div className="hp-grid-2" style={{ display: "grid", gridTemplateColumns: "380px 1fr", gap: 18, alignItems: "start" }}>
        <ScheduleAssignCard teams={teams} athletes={athletes} pitches={pitches} fixtures={fixtures} />
