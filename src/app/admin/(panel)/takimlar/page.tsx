...
export default async function TakimlarPage() {
  ...
  const teamRows: TeamRow[] = teams.map((t) => ({ id: t.id, name: t.name, short: t.short, coach: t.coach, born: t.born, coverImage: t.coverImage, sort: t.sort, athleteCount: t._count.athletes }));
